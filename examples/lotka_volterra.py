...
class LoktaVolterra(System):
    ...
    prey_birth_rate: Parameter = assign(default=0)
    prey_death_rate: Parameter = assign(default=0)
    predator_death_rate: Parameter = assign(default=0)
    predator_birth_rate: Parameter = assign(default=0)
